...
const config = {
  ...
  production: {
    API_BASE_URL: 'https://autojoinbot-production.up.railway.app',
    SOCKET_URL: 'https://autojoinbot-production.up.railway.app',
    MEDIA_BASE_URL: 'https://autojoinbot-production.up.railway.app/media',
...
export const getMediaUrl = (url) => {
  ...
  if (url.startsWith('http')) {
    ...
    if (url.includes('api.telegram.org')) {
      ...
      return `https://hopper.proxy.rlwy.net:19758/${url}`;
    }
    return url;
  }
